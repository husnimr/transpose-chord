...
export const CHORDS = {
  ...
  "A6": { fret: [-1, 0, 2, 2, 2, 2], note: "" },
  "B6": { fret: [-1, 2, 4, 4, 4, 4], note: "" },
  "C6": { fret: [-1, 3, 2, 0, 1, 0], note: "" },
  "D6": { fret: [-1, -1, 0, 2, 3, 2], note: "" },
  "E6": { fret: [0, 2, 2, 1, 0, 0], note: "" },
  "F6": { fret: [1, 3, 3, 2, 1, 1], note: "" },
  "G6": { fret: [3, 2, 0, 0, 3, 3], note: "" },
  ...
  "A/D#": { fret: [-1, 6, 2, 2, 2, 0], note: "" },
  "A/E": { fret: [-1, 0, 2, 2, 2, 0], note: "" },
  "A/F#": { fret: [-1, 4, 2, 2, 2, 2], note: "" },
  ...
  "C/F": { fret: [-1, 3, 3, 0, 1, 1], note: "" },
  "D/C#": { fret: [-1, 4, 0, 2, 3, 2], note: "" },
  "D/F#": { fret: [-1, -1, 4, 2, 3, 2], note: "" },
  "D/G": { fret: [-1, -1, 0, 2, 3, 5], note: "" },
  "E/D": { fret: [0, 2, 2, 1, 3, 0], note: "" },
  "E/G#": { fret: [4, 2, 2, 1, 0, 0], note: "" },
  "F/E": { fret: [0, 2, 2, 2, 1, 1], note: "" },
  "F/A": { fret: [1, 0, 3, 2, 1, 1], note: "" },
  "G/F#": { fret: [2, 2, 0, 0, 3, 3], note: "" },
  "G/B": { fret: [3, 2, 0, 0, 3, 2], note: "" },
  ...
  "Bdim": { fret: [-1, 2, 3, 4, 3, -1], note: "" },
  "Cdim": { fret: [-1, 3, 4, 5, 4, -1], note: "" },

  "Asus2": { fret: [-1, 0, 2, 2, 0, 0], note: "" },
  "Bsus2": { fret: [-1, 2, 4, 4, 2, 2], note: "" },
  "Csus2": { fret: [-1, 3, 2, 0, 0, 0], note: "" },
  "Dsus2": { fret: [-1, -1, 0, 2, 0, 0], note: "" },
  "Esus2": { fret: [0, 2, 2, 0, 0, 0], note: "" },
  "Fsus2": { fret: [1, 3, 3, 1, 1, 1], note: "" },
  "Gsus2": { fret: [3, 5, 5, 3, 3, 3], note: "" },

  "Cadd9": { fret: [-1, 3, 2, 0, 3, 0], note: "" },
  "Dadd9": { fret: [-1, -1, 0, 2, 0, 0], note: "" },
  "Eadd9": { fret: [0, 2, 4, 1, 0, 0], note: "" },

  "EmM7": { fret: [0, 2, 1, 1, 0, 0], note: "" },
  "F#m7b5": { fret: [2, -1, 2, 2, 1, -1], note: "" },
